...
export const zh: Record<string, string> = {
  ...
  rowHint: '按子代理 provider 名匹配；standard preset 中 spawn ↔ subagent 工具、fork ↔ subagent_fork 工具。',
...
export const en: Record<string, string> = {
  ...
  description: 'Pick a provider, model, and thinking effort for subagent / subagent_fork children, or inherit from the main agent.',
  ...
  effortHint: 'inherit = do not touch (forks inherit via session seed); default = explicitly use the model\u2019s default level.',
  rowHint: 'Matched by subagent provider name; in the standard preset spawn \u2194 subagent tool, fork \u2194 subagent_fork tool.',
