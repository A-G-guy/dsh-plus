...
| [`@dsh-plus/feature-toggle`](packages/feature-toggle) | 0.1.0 | service + UI | 功能开关管理器：按功能组开关官方插件与 dsh-plus 插件（子代理/工作流/搜索等），封闭目录保核心，异常自动回退 | [docs](packages/feature-toggle/docs/README.md) |
...
packages/
  ...
  feature-toggle/       功能开关管理器（官方+自研插件按功能组开关）
